...
load_dotenv(dotenv_path="/opt/airflow/dags/.env") # This loads your configuration values from the .env file inside the Airflow container.
...
def extract_from_minio():
    ...
    ) # This is an S3 client but pointing to MinIO instead of AWS.
