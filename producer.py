...
import json
import time
import uuid # For unique ID's for user's , songs and events
import random
from faker import Faker # To generate new ID's
from datetime import datetime
from kafka import KafkaProducer # Kafka client to send messages to a Kafka topic.
